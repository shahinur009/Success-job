    ...
    return (
        <>
            <div className="w-full max-w-md p-6 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <p className="mt-8 text-xs font-light text-center text-gray-400"> You have an account? <Link to='/login' href="#" className="font-medium text-gray-700 dark:text-gray-200 hover:underline">Please Login</Link></p>
            </div>
        </>
    );
};
