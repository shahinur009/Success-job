        ...
        <>
            <footer className="bg-base-100  text-white container px-8 py-8 mx-auto ">
                <div className="container rounded-md shadow-md mt-4 px-6 mx-auto">
                        ...
                        <div className="mt-6 lg:mt-0 lg:flex-1">
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                ...
                                <div>
                                    ...
                                    <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">All jobs</a>
                                    <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Blogs</a>
                                    <a href="#" className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Login</a>
                                </div>

                                <div>
                                    <h3 className="text-gray-700 uppercase dark:text-white">Contact</h3>
                                    <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">+8801744604009</span>
                                    <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Dhanmondi Dhaka</span>
                                    <span className="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">shaheenmis170879@email.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <p className="text-center text-gray-500 dark:text-gray-400">© Success Jobs  2024 - All rights reserved</p>
                    </div>
                </div>
            </footer>
        </>
