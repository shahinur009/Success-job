        ...
        <>
            <div title="Want to see detail first login" className="container md:mx-auto px-2 md:px-6 py-2 md:py-6 w-full md:w-96  border-2 rounded-md">
                ...
                <div className="flex justify-between items-center mt-2 md:mt-5">
                    ...
                    <p className="text-[12px] md:text-[16px]"> <span className="font-bold">Posting Date:</span> {posting_date}</p>
                ...
                <div className="flex justify-between items-center mt-5">
                    ...
                    <p className="text-[12px] md:text-[16px]"> <span className="font-bold">Applicants number:</span> {
                        applicants_number}</p>
                </div>
